...
urlpatterns = [
    ...
    path('chartDetailsMonthly/', views.get_chart_details_monthly, name='get_chart_details_monthly'),
    path('chartDetailsYearly/', views.get_chart_details_yearly, name='get_chart_details_yearly'),
